...
%% Load relevant files
load([basedir filesep 'training' filesep 'tuningCNN2dMedium']);            %"result"
...
%% train the model
model = fitCnn2dMedium(trainingData, trainingLabels, hyperparams);

mkdir([basedir filesep 'training' filesep 'models']);
save([basedir filesep 'training' filesep 'models' filesep 'Cnn2dMedium.mat'] ,"model")
