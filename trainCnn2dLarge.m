...
%% Load relevant files
load([basedir filesep 'training' filesep 'tuningCNN2dLarge']);            %"result"
...
%% train the model
model = fitCnn2dLarge(trainingData, trainingLabels, hyperparams);

mkdir([basedir filesep 'training' filesep 'models']);
save([basedir filesep 'training' filesep 'models' filesep 'Cnn2dLarge.mat'] ,"model")
