...
%% Load relevant files
load([basedir filesep 'training' filesep 'tuningCNN1dSmall']);            %"result"
...
%% train the model
model = fitCnn1dSmall(trainingData2, trainingLabels2, hyperparams);

mkdir([basedir filesep 'training' filesep 'models']);
save([basedir filesep 'training' filesep 'models' filesep 'Cnn1dSmall.mat'] ,"model")
